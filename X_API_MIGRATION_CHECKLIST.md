...
### 実績ベース（月6,604 Posts使用）
- 生徒数：約100名
- 月間評価回数：2回
- 月間Posts使用量：6,604 Posts
- User情報取得：100〜200回
...
### 月間コスト計算
- Post読み取り: 6,604 Posts × $0.005 = **$33.02**
- User情報取得: 100〜200 Users × $0.01 = **$1.00〜$2.00**
- **月間総コスト: $34〜$35**
...
|--------|------|----------|
| 旧Basic | $100〜$200 | - |
| 従量課金 | **$34〜$35** | **$780〜$1,980** |
| **削減率** | - | **66〜82%削減** |

**結論: 従量課金は旧Basicの1/3のコストで圧倒的に安い**
